(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tubugl-core'), require('gl-matrix/src/gl-matrix'), require('tubugl-2d-shape'), require('chroma-js'), require('gl-matrix')) :
	typeof define === 'function' && define.amd ? define(['exports', 'tubugl-core', 'gl-matrix/src/gl-matrix', 'tubugl-2d-shape', 'chroma-js', 'gl-matrix'], factory) :
	(factory((global.Tubu = {}),global.tubuglCore,global.glMatrix,global.tubugl2dShape,global.chroma,global.glMatrix$1));
}(this, (function (exports,tubuglCore,glMatrix,tubugl2dShape,chroma,glMatrix$1) { 'use strict';
